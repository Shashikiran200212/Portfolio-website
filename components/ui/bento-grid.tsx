  ...
  return (
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        <div className="w-full h-full absolute">
          {img && (
            <img
              src={img}
              alt={img}
              className={cn(imgClassName, 'object-cover object-center')} // ✅ fixed class
            />
          )}
        </div>
            ...
            <p className="font-extralight text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300">
              <q>
                <i>
                  ...
                  By actively listening and maintaining transparent communication, I keep clients informed with regular updates and honest feedback.
                  Scheduled check-ins facilitate real-time adjustments, while collaborative tools ensure all stakeholders are on the same page.
                  I remain adaptable to changes, educate clients about the development process, and provide ongoing support post-project to
        ...
        <div className={cn(
          titleClassName,
          'group-hover/bento:translate-x-2 transition duration-200 relative md:h-full min-h-0 flex flex-col px-5 p-5 lg:p-10'
        )}>
